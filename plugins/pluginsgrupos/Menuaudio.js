...
const handler = async (msg, { conn }) => {
  ...
  const caption = `𖠁🗂️ 𝙋𝘼𝙌𝙐𝙀𝙏𝙀𝙎 𝘿𝙀 𝙈𝙐𝙇𝙏𝙄𝙈𝙀𝘿𝙄𝘼𖠁
🎧 Audios, 🎞️ videos, 🖼️ imágenes, 🧩 stickers y más...

📝 *¿Cómo funciona?*
Solo escribe el *nombre del paquete* en el chat y *Danvers Bot Bot* enviará al azar uno de los archivos guardados dentro de ese paquete.
